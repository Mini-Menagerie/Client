...
const stripePromise = loadStripe(
    "pk_test_51HUN7sAjKylxkZ24d0YxRuxiDVNFIoEAsNmyg8WFxzcExHz1cPsfdouNHOsw3E9SJQpQ19rG2TFByvkQ3MNzAXey00DUfRySaY"
);
        ...
        <Container css={container}>
            ...
            <Container css={containerDetails}>
                <Col xs={7} css={itemDetails}>
                    ...
                    <div>
                        <p className="text-primary">
                            ...
                            Do not delay the purchase, adding items to your cart
                ...
                <Col xs={4} css={paymentDetails}>
                    ...
                    >
                        <div
                            css={buttonCheckoutLater}
                            onClick={handleCheckoutLater}
                            disabled={state.loading}
                        >
                            <Button>Checkout Later</Button>
                        </div>
                        <div
                            css={buttonCheckoutNow}
