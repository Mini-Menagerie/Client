        ...
        <Row>
            <Col xs={8} css={detail_section_col}>
                <Row css={detail_section_col_left_first_row}>
                    <img src={petDetails.image} style={{width:"710px", marginBottom:"30px"}} />
                    <h1>{petDetails.petName}</h1>
                    <h1>$ {petDetails.fee}</h1>
                </Row>
                <Row css={detail_section_col_left_second_row}>
                    <p>{petDetails.idBreed!== undefined && petDetails.idBreed.breedName}</p>
                    <h5>&bull;</h5>
            ...
            <Col xs={4} css={detail_section_col}>
                <h1>{petDetails.idUser!== undefined && petDetails.idUser.fullName}</h1>
                <h5>Pet Location</h5>
                <Row>
