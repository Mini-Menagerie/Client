...
import {
  ...
  widthButton, result, petsAvailable, displaying, filter
    ...
    <div>
      <div css={wrapperCover}>
        <div css={margin}>
          ...
          <Card css={card}>
            <FormControl onChange={handleChange} onKeyUp={getSearch} name='search' value={search} type="text" placeholder="e.g Animal Name" className="mr-sm-2" >
            </FormControl>
          </Card>
        </div>
        <div></div>
            ...
            <Col>
              <div className="sortBy" css={sortby}>
                <Form.Group as={Col} controlId="formGridFilter" >Sort By:
                  <Form.Control onChange={handleFilter} onClick={getFilter} as="select" defaultValue="Location" >
                    <option value="location-asc">Location</option>
                    <option value="gender-asc">Gender</option>
                    <option value="name-asc">Alphabet</option>
