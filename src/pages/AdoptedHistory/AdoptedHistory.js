        ...
        <div>
            ...
            <div css={listInfo}>
                {adoptedHistory.map(e => (
                    <div key={e._id}>
                    <Card>
                        <Card.Header className="text-center"><b>{e.idPetUpForAdoption.status}</b></Card.Header>
                        <Card.Body>
                            <div css={dated}>
                            ...
                            <Row>
                                ...
                                <Col css={desc}>
                                  <div>
                                    <b>{e.petName}</b> - <span>{e.breed}</span>
                                    <p>Adoption Fee : IDR{e.idPetUpForAdoption.fee}</p>
                                  </div>
                                </Col>
                            </Row>
                        </Card.Body>
